...
/// <c>%APPDATA%\OpenTibiaVision\routes.json</c> (was TibiaVision in the original); the MapWindow
...
public class JsonRouteStore : IRouteStore
{
    ...
    {
        _filePath = filePath ?? Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "OpenTibiaVision", "routes.json");
