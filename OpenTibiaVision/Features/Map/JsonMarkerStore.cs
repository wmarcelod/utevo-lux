...
/// <c>%APPDATA%\OpenTibiaVision\markers.json</c> (was TibiaVision in the original); the MapWindow
...
public class JsonMarkerStore : IMarkerStore
{
    ...
    {
        _filePath = filePath ?? Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "OpenTibiaVision", "markers.json");
